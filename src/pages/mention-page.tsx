...
const MentionPage = () => {
  const { bio } = useInfo();
  return (
    <div className="w-screen flex flex-col px-8 pb-8">
      <Navbar />
      <div className="w-full flex flex-col md:flex-row gap-8 mt-[4rem]">
        <div className="w-full md:w-1/2 h-1/2 aspect-square">
          <motion.img
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <motion.div
          ...
          className="md:w-1/2 w-full h-auto px-3"
        >
          <p className="text-[28px] md:text-[40px] bold mt-2">MATIAS RENAUD</p>
